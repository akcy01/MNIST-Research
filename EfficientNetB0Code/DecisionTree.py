...
print("EfficientNetB0 ile Karar Ağacı Modeli Doğruluğu:", accuracy_tree)

# Precision
precision_svm = precision_score(y_test, predictions_tree, average='weighted')
print("EfficientNetB0 ile Karar Ağacı Modeli Doğruluğu: Precision:", precision_svm)

# Recall
recall_svm = recall_score(y_test, predictions_tree, average='weighted')
print("EfficientNetB0 ile Karar Ağacı Modeli Doğruluğu: Recall:", recall_svm)

# F1 Score
f1_svm = f1_score(y_test, predictions_tree, average='weighted')
print("EfficientNetB0 ile Karar Ağacı Modeli Doğruluğu: F1 Score:", f1_svm)