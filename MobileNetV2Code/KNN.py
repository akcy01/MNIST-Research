...
print("MobileNetV2 ile K-Nearest Neighbors Modeli Doğruluğu:", accuracy_knn)

# Precision
precision_knn = precision_score(y_test, predictions_knn, average='weighted')
print("MobileNetV2 ile K-Nearest Neighbors Modeli Doğruluğu: Precision:", precision_knn)

# Recall
recall_knn = recall_score(y_test, predictions_knn, average='weighted')
print("MobileNetV2 ile K-Nearest Neighbors Modeli Doğruluğu: Recall:", recall_knn)

# F1 Score
f1_knn = f1_score(y_test, predictions_knn, average='weighted')
print("MobileNetV2 ile K-Nearest Neighbors Modeli Doğruluğu: F1 Score:", f1_knn)