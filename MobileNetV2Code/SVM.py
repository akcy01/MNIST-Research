...
# Support Vector Machine modelini oluşturma ve eğitme
svm_classifier = SVC()
...
print("MobileNetV2 ile Support Vector Machine Modeli Doğruluğu:", accuracy_svm)

# Precision
precision_svm = precision_score(y_test, predictions_svm, average='weighted')
print("MobileNetV2 ile Support Vector Machine Modeli Doğruluğu: Precision:", precision_svm)

# Recall
recall_svm = recall_score(y_test, predictions_svm, average='weighted')
print("MobileNetV2 ile Support Vector Machine Modeli Doğruluğu: Recall:", recall_svm)

# F1 Score
f1_svm = f1_score(y_test, predictions_svm, average='weighted')
print("MobileNetV2 ile Support Vector Machine Modeli Doğruluğu: F1 Score:", f1_svm)